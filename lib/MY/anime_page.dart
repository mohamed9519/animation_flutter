...
class AnimePage extends StatelessWidget {
  AnimePage({@required this.anime, @required AnimationController controller})
            ...
            child: new Opacity(
                ...
                child: new SizedBox.fromSize(
                  ...
                  child: ListView.builder(
                      ...
                      itemCount: anime.watch.length,
                      itemBuilder: (BuildContext context, int index) {
                        var watches = anime.watch[index];
                        return new AWatchCard(watches);
                      }),
                ))));
  }
}
